...
Application
    compressibleInterPhaseChangeFoam
...
Description
    ...
    -----> Objective is to add phase change from interPhaseChangeFoam
...
// Modifs pour le changement de phase
...
int main(int argc, char *argv[])
{
    ...
    #include "pSatClapeyron.H"
    #include "TSatClapeyron.H"
